...
public class Vlahou2DE {
    ...
    String base = "http://www.e-lico.eu/data/kupkb/experiment/valhou2DE_";

    IRI lcmsAnalysisIRI = IRI.create(kupkbURI + "2DEProteinAnalysis");
    IRI analysisOf = IRI.create(kupkbURI + "analysisOf");
    IRI lcmsList = IRI.create(kupkbURI + "2DEProteinList");
    ...
    public Vlahou2DE() {
        ...
        try {
            ...
            mann_ontology = manager.createOntology(IRI.create("http://www.e-lico.eu/data/kupkb/experiment/VLAHOU2DE"));
        ...
        try {
            BufferedReader input =  new BufferedReader(new FileReader(new File("/Users/simon/dev/kupo/kupdb/version2/experiments/vlahou/Control_Urine_Protein_Vlahou_2DE.csv")));
        ...
        try {
            manager.saveOntology(mann_ontology, IRI.create("file:/Users/simon/Documents/e-lico/svn/trunk/software/ontologies/kupkb/vlahou2DE.owl"));
