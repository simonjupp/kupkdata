...
public class Mann {
    ...
    String base = "http://www.e-lico.eu/data/kupkb/experiment/mann_";

    IRI lcmsAnalysisIRI = IRI.create(kupkbURI + "LC-MS_MS_MSAnalysis");
    IRI analysisOf = IRI.create(kupkbURI + "analysisOf");
    IRI lcmsList = IRI.create(kupkbURI + "LC_MS_MS_MS_ProteinList");
    ...
    public Mann () {
        ...
        try {
            ...
            mann_ontology = manager.createOntology(IRI.create("http://www.e-lico.eu/data/kupkb/experiment/MANN"));


            OWLNamedIndividual experimentAssayType = factory.getOWLNamedIndividual(IRI.create(base + "assay"));
            OWLAxiom ax = factory.getOWLClassAssertionAxiom(factory.getOWLClass(IRI.create("http://www.e-lico.eu/data/kupkb/v2/LC_MS_MS_MSProteinAssay")), experimentAssayType);
        ...
        try {
            BufferedReader input =  new BufferedReader(new FileReader(new File("/Users/simon/dev/kupo/kupdb/version2/experiments/mann/Control_Urine_Protein_Mann.csv")));
        ...
        try {
            manager.saveOntology(mann_ontology, IRI.create("file:/Users/simon/Documents/e-lico/svn/trunk/software/ontologies/kupkb/mann.owl"));
